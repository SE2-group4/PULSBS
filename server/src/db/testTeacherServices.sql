...
INSERT INTO Lecture(lectureId, courseId, classId, startingDate, duration, bookingDeadline, delivery) VALUES(4, 2, 2, DATETIME('now', '-2 day', 'start of day', '10 hours', '00 minutes'), 1000*60*90, DATETIME('now', '-3 day', 'start of day', '23 hours', '59 minutes'), 'PRESENCE');
