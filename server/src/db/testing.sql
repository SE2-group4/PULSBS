...
INSERT INTO EmailQueue(queueId, sender, recepient, emailType, teacherId, studentId, courseId, courseName, lectureId, startingDate) VALUES(1, 'test sender', 'test recepient', 'STUDENT_NEW_BOOKING', 4, 1, 1, 1, DATETIME('now', '-1 day', 'start of day', '8 hours', '30 minutes'));
INSERT INTO EmailQueue(queueId, sender, recepient, emailType, teacherId, studentId, courseId, courseName, lectureId, startingDate) VALUES(2, 'test sender', 'test recepient', 'LESSON_CANCELLED', 4, 1, 1, 1, DATETIME('now', '-1 day', 'start of day', '8 hours', '30 minutes'));
INSERT INTO EmailQueue(queueId, sender, recepient, emailType, teacherId, studentId, courseId, courseName, lectureId, startingDate) VALUES(3, 'test sender', 'test recepient', 'TEACHER_ATTENDING_STUDENTS', 4, 1, 1, 1, DATETIME('now', '-1 day', 'start of day', '8 hours', '30 minutes'));
