...
INSERT INTO Lecture(lectureId, courseId, classId, startingDate, duration, bookingDeadline, delivery) VALUES(1, 1, 1, DATETIME('now', 'weekday 1', 'start of day', '1 week', '8 hours', '30 minutes'), 1000*60*90, DATETIME('now', 'weekday 0', 'start of day', '1 week', '23 hours', '00 minutes'), 'PRESENCE');
INSERT INTO Lecture(lectureId, courseId, classId, startingDate, duration, bookingDeadline, delivery) VALUES(1, 1, 1, DATETIME('now', 'weekday 1', 'start of day', '2 week', '8 hours', '30 minutes'), 1000*60*90, DATETIME('now', 'weekday 0', 'start of day', '1 week', '23 hours', '00 minutes'), 'PRESENCE');
